...
//  Generator functions
    ...
    **/
    ...
    enum {Neutrino, Positron, Neutron, Electron, K40, U238, U235, Th232, DecayChain, Photon, Visualization, wave, beam}; //make sure this order is the same in primary generator class enum
