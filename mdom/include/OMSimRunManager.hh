...
//  Generator functions
    ...
    **/
    ...
    enum {Positron, Neutron, Electron, K40, U238, U235, Th232, Photon, Visualization, wave, beam, muon}; //make sure this order is the same in primary generator class enum
