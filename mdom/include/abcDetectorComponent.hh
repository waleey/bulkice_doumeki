...
class Component {     // Struct of variables of component of a DetectorComponent
   public:
        ...
        : VSolid(0), VLogical(0), Name(name) {}
        Component(G4VSolid* vsolid, G4LogicalVolume* vlogical, G4ThreeVector pos, G4RotationMatrix rot, G4String name)
        : VSolid(vsolid), VLogical(vlogical), Position(pos), Rotation(rot), Name(name) {}
        virtual ~Component() {}
...
public:
    ...
    virtual void AppendComponent(G4VSolid* pSolid, G4LogicalVolume* pLogical, G4ThreeVector pVector, G4RotationMatrix pRotation, G4String pName);
    virtual Component GetComponent(G4String pName);
