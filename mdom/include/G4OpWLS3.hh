...
class G4OpWLS3 : public G4VDiscreteProcess
{
 public:
  explicit G4OpWLS3(const G4String& processName = "OpWLS",
 ...
 private:
  G4OpWLS3(const G4OpWLS3& right) = delete;
  G4OpWLS3& operator=(const G4OpWLS3& right) = delete;
...
inline G4bool G4OpWLS3::IsApplicable(const G4ParticleDefinition& aParticleType)
{
  return (&aParticleType == G4OpticalPhoton::OpticalPhoton());
}

inline G4PhysicsTable* G4OpWLS3::GetIntegralTable() const
{
  return theIntegralTable;
}

inline void G4OpWLS3::DumpPhysicsTable() const
{
